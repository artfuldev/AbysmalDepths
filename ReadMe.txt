...
Story Files, if they don't need a choice file, can have > or >nextStoryFileName at the END
This improves the story reading experience of the user ashe can read bits of the stories at a time
This can also simulate scenarios of resting and dreaming about the past (which was the original idea)
